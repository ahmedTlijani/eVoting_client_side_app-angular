...
export class ChainData {
	...
	public createBlock(electeur: Electeur,parti:Parti):Block // creating block with electeur and to who he voted 
	{
		var p = new BlockData(parti.parti_id,electeur.hash_code); // votedTo ,voter public hash
